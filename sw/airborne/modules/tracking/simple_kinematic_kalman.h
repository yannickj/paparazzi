...
/** @file "modules/tracking/simple_kinematic_kalman.h"
...
struct SimpleKinematicKalman {
  ...
  float H[SIMPLE_KINEMATIC_KALMAN_DIM / 2][SIMPLE_KINEMATIC_KALMAN_DIM];  ///< observation matrix
 ...
 *
 * @param[in] kalman SimpleKinematicKalman structure
 * @param[in] target position of the target from which the distance is measured
 */
extern void simple_kinematic_kalman_update(struct SimpleKinematicKalman *kalman, struct FloatVect3 target);
 ...
 */
extern void simple_kinematic_kalman_update_speed(struct SimpleKinematicKalman *kalman, float speed, uint8_t type);
