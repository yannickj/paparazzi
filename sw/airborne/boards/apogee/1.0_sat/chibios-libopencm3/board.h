...
#define BOARD_NAME  "AB/GRZ STM32F4 Apogee 1.0_sat"
...
#define GPIOA_IRIDIUM_POWER         5 // was SCK1
#define GPIOA_IRIDIUM_GETLINK       6 // was MISO1
#define GPIOA_SDIO_DETECT           7 // was MOSI1
...
#define GPIOA_IRIDIUM_RI            15 // IRIDIUM Ring Indicator (Short Message Pending)

#define GPIOB_PWM3_CH3              0 // SERVO 0  
#define GPIOB_AUX_PIN1              1 // AUX_SRV_6 (TIM3_CHANNEL_4 when pwm)
...
#define GPIOB_IRIDIUM_SLEEP         9  // was CS1 
#define GPIOB_USART3_TX             10 // iridium usart with flow control
#define GPIOB_USART3_RX		    11 // iridium usart with flow control
#define GPIOB_APSW_PIN12            12 // Commande power switch APSW
#define GPIOB_USART3_CTS            13 // iridium usart with flow control
#define GPIOB_USART3_RTS            14 // iridium usart with flow control
...
#define GPIOC_LED4                  3 // 
#define GPIOC_AUX_PIN4              4 // AUX_ADC capable (adc1 in14) : current sensor
#define GPIOC_AUX_PIN5              5 // AUX_ADC capable (adc1 in15) : air speed sensor
 ...
 * GPIOA_IRIDIUM_POWER              5 				      
 * GPIOA_IRIDIUM_GETLINK             6				      
 * GPIOA_SDIO_DETECT             7				      
...
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_UART4_TX) |    \
				     ...
				     PIN_MODE_ALTERNATE(GPIOA_USART2_RX) |   \
                                     ...
                                     PIN_MODE_OUTPUT   (GPIOA_IRIDIUM_POWER) |     \
                                     PIN_MODE_INPUT    (GPIOA_IRIDIUM_GETLINK) |   \
                                     PIN_MODE_INPUT(GPIOA_SDIO_DETECT) |        \
                                     ...
                                     PIN_MODE_INPUT(GPIOA_IRIDIUM_RI))            
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_UART4_TX) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_IRIDIUM_POWER) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_IRIDIUM_GETLINK) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SDIO_DETECT) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_IRIDIUM_RI))                     
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_100M(GPIOA_UART4_TX) |     \
                                     ...
                                     PIN_OSPEED_100M(GPIOA_IRIDIUM_POWER) |      \
                                     PIN_OSPEED_100M(GPIOA_IRIDIUM_GETLINK) |    \
                                     PIN_OSPEED_100M(GPIOA_SDIO_DETECT) |     \
                                     ...
                                     PIN_OSPEED_100M(GPIOA_IRIDIUM_RI))            
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_UART4_TX) |     \
				     ...
				     PIN_PUPDR_FLOATING(GPIOA_USART2_RX) |    \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_IRIDIUM_POWER) |      \
                                     PIN_PUPDR_FLOATING(GPIOA_IRIDIUM_GETLINK) |    \
                                     PIN_PUPDR_PULLUP(GPIOA_SDIO_DETECT) |     \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_IRIDIUM_RI))          
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_UART4_TX) |     \
                                     ...
                                     PIN_ODR_LOW(GPIOA_IRIDIUM_POWER) |      \
                                     PIN_ODR_HIGH(GPIOA_IRIDIUM_GETLINK) |    \
                                     PIN_ODR_HIGH(GPIOA_SDIO_DETECT) |     \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_UART4_TX, 8) |	\
				     ...
				     PIN_AFIO_AF(GPIOA_IRIDIUM_POWER, 0) |    \
				     PIN_AFIO_AF(GPIOA_IRIDIUM_GETLINK, 0) |  \
				     PIN_AFIO_AF(GPIOA_SDIO_DETECT, 0))
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_ICU1_CH1, 1) |     \
                                     ...
                                     PIN_AFIO_AF(GPIOA_IRIDIUM_RI, 0))           
...
#define VAL_GPIOB_MODER             (PIN_MODE_ALTERNATE(GPIOB_PWM3_CH3)        | \
				     ...
				     PIN_MODE_ALTERNATE(GPIOB_PWM3_CH2)    | \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_IRIDIUM_SLEEP)            | \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PWM3_CH3)    | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_IRIDIUM_SLEEP)        | \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_100M(GPIOB_PWM3_CH3) |          \
                                     ...
                                     PIN_OSPEED_100M(GPIOB_IRIDIUM_SLEEP) |           \
                                     PIN_OSPEED_100M(GPIOB_USART3_TX) |     \
                                     PIN_OSPEED_100M(GPIOB_USART3_RX) |     \
                                     PIN_OSPEED_100M(GPIOB_APSW_PIN12) |         \
                                     PIN_OSPEED_100M(GPIOB_USART3_CTS) |         \
                                     PIN_OSPEED_100M(GPIOB_USART3_RTS) |         \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_PWM3_CH3) |         \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_IRIDIUM_SLEEP) |        \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PWM3_CH3) |             \
                                     ...
                                     PIN_ODR_LOW(GPIOB_IRIDIUM_SLEEP) |              \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_I2C1_SCL, 0) |       \
                                     PIN_AFIO_AF(GPIOB_IRIDIUM_SLEEP, 0) |       \
                                     PIN_AFIO_AF(GPIOB_USART3_TX, 7) |       \
                                     PIN_AFIO_AF(GPIOB_USART3_RX, 7) |       \
                                     PIN_AFIO_AF(GPIOB_APSW_PIN12, 0) |          \
                                     PIN_AFIO_AF(GPIOB_USART3_CTS, 7) |          \
                                     PIN_AFIO_AF(GPIOB_USART3_RTS, 7) |          \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_LED1) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOC_AUX_PIN5) |         \
