...
class GTK_Main:
        ...
        def __init__(self):
                ...
                self.player = gst.parse_launch ("udpsrc uri=udp://0.0.0.0:5000  caps = \"application/x-rtp, media=(string)video, clock-rate=(int)90000, encoding-name=(string)MP4V-ES, payload=(int)96\" ! rtpmp4vdepay ! ffdec_mp4 ! ffmpegcolorspace ! ximagesink")
